...
if (isset($validerCo)) {
  ...
  if ($_SESSION['csrf_token'] !== $csrf) {
    ...
    $messageError = "CRSF Token Invalide !";
    $error = "alert-error";
...
if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
  ...
  $_SESSION['csrf_token'] = bin2hex(random_bytes(20));
  callConnexion($messageConnexion, $error, @$goodMail, $_SESSION['csrf_token']);
  callInscription($_SESSION['csrf_token']);
}
