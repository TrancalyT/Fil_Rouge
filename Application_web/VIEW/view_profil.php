        ...
        <section class="info border bg-light">
            ...
            <div class="col-12">
                <div class="clearfix row align-items-center justify-content-center">
                    ...
                    <div class="col-6">
                    <input size="20" maxlength="100" type="text" name="nickname" value="<?php echo $_SESSION['user_nickname'] ?>">
                    <input size="20" maxlength="100" type="text" name="name" value="<?php echo $_SESSION['user_name'] ?>">
                    <input size="20" maxlength="100" type="text" name="lastname" value="<?php echo $_SESSION['user_lastname'] ?>">
                    <input size="20" maxlength="100" type="mail" name="mail" value="<?php echo $_SESSION['user_mail'] ?>">  
                    </div>
                </div>
            </div>
            </section>
